...
public class UserResource { // UserResource que é um RestController
	
	@Autowired
	private UserService service; //UserResource que é um RestController tem a Dependencia com o Service
	...
	//endpoint inserir Banco de dados
	@PostMapping
	...
	//endpoint deletar banco de dados
	...
	@PutMapping(value = "/{id}")//metodo http put
